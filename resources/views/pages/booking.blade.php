  ...
  <div class="w-full">
    ...
    <div class="w-full self-stretch inline-flex flex-col justify-center items-start gap-5">
      <div class="w-full space-y-2">
        ...
        <input type="text" id="full_name" name="full_name" placeholder="What's your full name?"
      ...
      <div class="w-full space-y-2">
        ...
        <input type="email" id="email" name="email" placeholder="Can we get your email?"
          class="w-full rounded-full border border-gray-300 bg-gray-50 px-5 py-3 text-sm placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300" />
      </div>
      <div class="w-full space-y-2">
        ...
        <input type="tel" id="phone_number" name="phone_number" placeholder="e.g. +62 812 3456 7890"
          class="w-full rounded-full border border-gray-300 bg-gray-50 px-5 py-3 text-sm placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300" />
      </div>
    </div>
  </div>
      ...
      <div class="w-full space-y-2">
        ...
        <div class="w-full grid grid-cols-2 gap-4">
          <label class="flex items-center gap-2 cursor-pointer">
            <input type="radio" name="payment" value="dp" class="text-gray-900 focus:ring-gray-300">
            <span class="text-sm text-gray-700">Down Payment (50%)</span>
          </label>
          <label class="flex items-center gap-2 cursor-pointer">
            <input type="radio" name="payment" value="full" class="text-gray-900 focus:ring-gray-300">
    ...
    <div class="w-full self-stretch inline-flex flex-col justify-center items-start gap-5">
      ...
      <div class="w-full space-y-2">
        ...
        <textarea id="notes" name="notes" rows="4" placeholder="Any special requests or additional information..."
          class="w-full rounded-2xl border border-gray-300 bg-gray-50 px-5 py-3 text-sm placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300 resize-none"></textarea>
      </div>
    </div>
  </div>
...
@push('scripts')
<script src="{{ asset('../resources/js/components/bookingSlide.js') }}"></script>
